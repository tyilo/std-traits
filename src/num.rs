    ...
    + UpperHex
{
    ...
    /// See [`i32::isolate_highest_one`].
    #[must_use = "this returns the result of the operation, without modifying the original"]
    fn isolate_highest_one(self) -> Self;

    /// See [`i32::isolate_lowest_one`].
    #[must_use = "this returns the result of the operation, without modifying the original"]
...
macro_rules! impl_integer {
    ($ty:ty, $unsigned:ty, $signed:ty, abs: $abs:expr, signum: $signum:expr) => {
        ...
        impl Integer for $ty {
            ...
            fn isolate_highest_one(self) -> Self {
                Self::isolate_highest_one(self)
            }

            fn isolate_lowest_one(self) -> Self {
                Self::isolate_lowest_one(self)
            }

            fn highest_one(self) -> Option<u32> {
                Self::highest_one(self)
            }

            fn lowest_one(self) -> Option<u32> {
                Self::lowest_one(self)
            }
